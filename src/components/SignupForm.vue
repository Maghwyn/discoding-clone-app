        ...
        <div class="centering-wrapper">
          <div class="section1 text-center">
            ...
            <div class="form-group">
                ...
                <input type="email" v-model="emailSignup" required="true" name="logemail" class="form-style" id="logemail" autocomplete="off" style="margin-bottom: 20px;">
                <i class="input-icon uil uil-at"></i>
            </div>	
            <div class="form-group">
                <h5 class="input-placeholder" id="pword-txt">Password<span class="error-message" id="password-error"></span></h5>
                <input type="password" v-model="passwordSignup" required="true" name="logpass" class="form-style" id="logpass" autocomplete="on">
